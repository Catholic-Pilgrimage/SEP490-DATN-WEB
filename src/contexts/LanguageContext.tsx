...
const translations: Record<Language, Record<string, string>> = {
    vi: {
        ...
        'sites.sites': 'sites',
        'sites.addSite': 'Thêm Site',
        'sites.createTitle': 'Tạo Site Mới',
        'sites.createSite': 'Tạo Site',
        'sites.creating': 'Đang tạo...',
        'sites.createSuccess': 'Tạo thành công',
        'sites.createSuccessMsg': 'Site mới đã được tạo',
        'sites.createFailed': 'Tạo thất bại',
        'sites.createFailedMsg': 'Không thể tạo site mới',
        ...
        'openingHours.applyAll': 'Áp dụng cho tất cả',
        'openingHours.applyWeekdays': 'T2-T6',
        'openingHours.applyWeekend': 'T7-CN',
        ...
        'verificationDetail.clickToViewImage': 'Click để xem ảnh',
        'verificationDetail.clickToOpenPDF': 'Click để mở PDF trong tab mới',
        'verificationDetail.clickToOpenDoc': 'Click để mở DOCX trong tab mới',
        'verificationDetail.clickToView': 'Click để xem',
        'verificationDetail.cannotLoadDocument': 'Không thể tải tài liệu',
        'verificationDetail.documentError': 'Tài liệu có thể bị lỗi hoặc không tồn tại',
        'verificationDetail.tryOpenNewTab': 'Thử mở trong tab mới',
        ...
        'sos.assignGuideTitle': 'Chỉ định Hướng dẫn viên xử lý SOS',
        'sos.assignGuideSubtitle': 'Chọn một Hướng dẫn viên thuộc khu vực để tiếp nhận và xử lý yêu cầu SOS này.',
        'sos.selectGuide': 'Chọn Hướng dẫn viên',
        'sos.searchGuide': 'Tìm kiếm hướng dẫn viên...',
        'sos.loadingGuides': 'Đang tải danh sách...',
        'sos.noGuidesAvailable': 'Không có hướng dẫn viên nào khả dụng',
        'sos.confirmAssign': 'Xác nhận phân công',
        'sos.assigning': 'Đang phân công...',
        'sos.assignSuccess': 'Phân công thành công!',
        'sos.assignSuccessMsg': 'Hướng dẫn viên đã được chỉ định xử lý SOS.',
        'sos.notes': 'Ghi chú xử lý',
        'sos.assignFailed': 'Phân công thất bại!',
        'sos.sosCode': 'Mã SOS',
        'sos.guideName': 'Hướng dẫn viên',
        'sos.guidePhone': 'SĐT',
        'sos.guideEmail': 'Email',
        ...
        'rpt.reason.hate_speech': 'Ngôn từ thù ghét',
        'rpt.reason.scam': 'Lừa đảo',
        'rpt.reason.violence': 'Bạo lực',
        'rpt.reason.false_information': 'Thông tin sai sự thật',
        ...
        'rpt.detail.postStatusPublished': 'Đã xuất bản',
        'rpt.detail.postStatusDraft': 'Bản nháp',
        'rpt.detail.postStatusArchived': 'Đã lưu trữ',
        'rpt.detail.postStatusHidden': 'Đã ẩn',
        ...
        'rpt.modal.actionRejected': 'Từ chối báo cáo',
        'rpt.modal.note': 'Ghi chú xử lý (Bắt buộc khi từ chối)',
        ...
        'aiPrompts.subtitle': 'Quản lý các prompt instructions cho AI (chỉ dành cho Admin)',
        'aiPrompts.description': 'Mô tả',
        'aiPrompts.instructionText': 'Instruction Text',
        'aiPrompts.version': 'Version',
        'aiPrompts.custom': 'Custom',
        'aiPrompts.default': 'Default',
        'aiPrompts.customTooltip': 'Prompt tùy chỉnh được lưu trong database',
        'aiPrompts.defaultTooltip': 'Prompt mặc định từ hệ thống',
        'aiPrompts.chars': 'ký tự',
        'aiPrompts.viewTitle': 'Xem AI Prompt',
        'aiPrompts.editTitle': 'Chỉnh sửa AI Prompt',
        'aiPrompts.editPrompt': 'Chỉnh sửa',
        'aiPrompts.descriptionPlaceholder': 'Mô tả ngắn gọn về prompt này...',
        'aiPrompts.instructionPlaceholder': 'Nhập instruction text cho AI...',
        'aiPrompts.characters': 'ký tự',
        'aiPrompts.saveChanges': 'Lưu thay đổi',
        'aiPrompts.saving': 'Đang lưu...',
        'aiPrompts.loadError': 'Không thể tải danh sách AI prompts',
        'aiPrompts.updateSuccess': 'Cập nhật thành công',
        'aiPrompts.updateSuccessMsg': 'AI prompt đã được cập nhật',
        'aiPrompts.updateFailed': 'Cập nhật thất bại',
        'aiPrompts.updateFailedMsg': 'Không thể cập nhật AI prompt',
    },
    en: {
        // Sidebar
        ...
        'sites.createTitle': 'Create New Site',
        'sites.createSite': 'Create Site',
        'sites.creating': 'Creating...',
        'sites.createSuccess': 'Created successfully',
        'sites.createSuccessMsg': 'New site has been created',
        'sites.createFailed': 'Creation failed',
        'sites.createFailedMsg': 'Could not create new site',
        ...
        // Opening Hours Quick Actions
        'openingHours.applyAll': 'Apply to All',
        'openingHours.applyWeekdays': 'Mon-Fri',
        'openingHours.applyWeekend': 'Sat-Sun',
        ...
        'verificationDetail.clickToViewImage': 'Click to view image',
        'verificationDetail.clickToOpenPDF': 'Click to open PDF in new tab',
        'verificationDetail.clickToOpenDoc': 'Click to open DOCX in new tab',
        'verificationDetail.clickToView': 'Click to view',
        'verificationDetail.cannotLoadDocument': 'Cannot load document',
        'verificationDetail.documentError': 'Document may be corrupted or does not exist',
        'verificationDetail.tryOpenNewTab': 'Try opening in new tab',
        ...
        'sos.assignGuideTitle': 'Assign Guide to Handle SOS',
        'sos.assignGuideSubtitle': 'Select a Local Guide in the area to handle this SOS request.',
        'sos.selectGuide': 'Select Guide',
        'sos.searchGuide': 'Search guide...',
        'sos.loadingGuides': 'Loading guides...',
        'sos.noGuidesAvailable': 'No guides available',
        'sos.confirmAssign': 'Confirm Assignment',
        'sos.assigning': 'Assigning...',
        'sos.assignSuccess': 'Assignment Successful!',
        'sos.assignSuccessMsg': 'Guide has been assigned to handle the SOS.',
        'sos.notes': 'Processing Notes',
        'sos.assignFailed': 'Assignment Failed!',
        'sos.sosCode': 'SOS Code',
        'sos.guideName': 'Guide',
        'sos.guidePhone': 'Phone',
        'sos.guideEmail': 'Email',
        ...
        'rpt.reason.hate_speech': 'Hate Speech',
        'rpt.reason.scam': 'Scam',
        'rpt.reason.violence': 'Violence',
        'rpt.reason.false_information': 'False Information',
        ...
        'rpt.detail.postStatusPublished': 'Published',
        'rpt.detail.postStatusDraft': 'Draft',
        'rpt.detail.postStatusArchived': 'Archived',
        'rpt.detail.postStatusHidden': 'Hidden',
        ...
        'rpt.modal.actionRejected': 'Reject Report',
        'rpt.modal.note': 'Resolution Note (Required when rejecting)',
        ...
        // AI Prompts
        'aiPrompts.title': 'AI Prompts',
        'aiPrompts.subtitle': 'Manage AI prompt instructions (Admin only)',
        'aiPrompts.description': 'Description',
        'aiPrompts.instructionText': 'Instruction Text',
        'aiPrompts.version': 'Version',
        'aiPrompts.custom': 'Custom',
        'aiPrompts.default': 'Default',
        'aiPrompts.customTooltip': 'Custom prompt saved in database',
        'aiPrompts.defaultTooltip': 'Default prompt from system',
        'aiPrompts.chars': 'chars',
        'aiPrompts.viewTitle': 'View AI Prompt',
        'aiPrompts.editTitle': 'Edit AI Prompt',
        'aiPrompts.editPrompt': 'Edit',
        'aiPrompts.descriptionPlaceholder': 'Brief description of this prompt...',
        'aiPrompts.instructionPlaceholder': 'Enter instruction text for AI...',
        'aiPrompts.characters': 'characters',
        'aiPrompts.saveChanges': 'Save Changes',
        'aiPrompts.saving': 'Saving...',
        'aiPrompts.loadError': 'Could not load AI prompts',
        'aiPrompts.updateSuccess': 'Update successful',
        'aiPrompts.updateSuccessMsg': 'AI prompt has been updated',
        'aiPrompts.updateFailed': 'Update failed',
        'aiPrompts.updateFailedMsg': 'Could not update AI prompt',
    },
};
